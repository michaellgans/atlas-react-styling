...
export function PlayListItem() {
  // Define Hook
  return (
    <div className="play-list-item mb-1 flex h-10 items-center justify-between rounded-md text-sm font-medium hover:bg-hover active:bg-active dark:hover:bg-dark-hover dark:active:bg-dark-active">
